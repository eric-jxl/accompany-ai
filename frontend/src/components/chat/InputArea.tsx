...
export const InputArea: React.FC<InputAreaProps> = ({
    ...
    return (
        <div className="fixed bottom-3 inset-x-0 z-40 pb-[env(safe-area-inset-bottom)]">
            {/* 背景渐变效果 */}
            <div
        ...
        `}>
          ...
          `}>
                        {/* 顶部工具栏 */}
                        <div
                            className="flex items-center justify-between px-4 py-2 border-b border-gray-100 dark:border-gray-700/50">
                ...
                {isOverLimit && (
                    <div
                        className="mt-2 mx-4 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
